...
\newcommand{\xiaosionetwo}{\fontsize{12pt}{11.55pt}\selectfont}      % 小四, 20磅 = word 1.2倍行距
...
%              {\hspace{.5em}\titlerule*[10pt]{$\cdot$}\sihao\contentspage}
% \titlecontents{section}[2em]{\vspace{.5\baselineskip}\xiaosan\song}
%             {\thecontentslabel\qquad}{}
%             {\hspace{.5em}\titlerule*[10pt]{$\cdot$}\sihao\contentspage}
...
\titlecontents{section}[0em]{\zihao{4}\song}
  {\thecontentslabel ~~ }{}
  {\hspace{.5em} \titlerule*[0.7pc]{$\cdot$}\contentspage}%

\titlecontents{subsection}[1em]{\zihao{-4}\song}
  {\thecontentslabel ~~ }{}
  {\hspace{.5em} \titlerule*[0.7pc]{$\cdot$}\contentspage}%

\titlecontents{subsubsection}[2em]{\zihao{-4}\song}
  {\thecontentslabel ~~ }{}
  {\hspace{.5em} \titlerule*[0.7pc]{$\cdot$}\contentspage}%
...
% \titleformat{\section}{\centering\sihao\hei}{\thesection}{2em}{}
...
\renewcommand{\tablename}{\kai\wuhao 表}                                     % 插表题头
\renewcommand{\figurename}{\kai\wuhao 图}                                    % 插图题头
\renewcommand{\thefigure}{\arabic{section}-\arabic{figure}}       % 使图编号为 7-1 的格式 %\protect{~}
\renewcommand{\thesubfigure}{\alph{subfigure})}                   % 使子图编号为 a) 的格式
\renewcommand{\thesubtable}{(\alph{section})}                    % 使子表编号为 (a) 的格式

...
\usepackage{float}
\usepackage{fancyhdr} 
\usepackage[a4paper, top=3.5cm, bottom=2.5cm, left=2.5cm, right=2.5cm, footskip=2.5cm]{geometry}
%---------------------------------------------------------------------------%
%-                                  Fonts                                  -%
%---------------------------------------------------------------------------%
...
\fancypagestyle{all}{  % 第二种页眉样式
    \fancyhf{}  % 清空默认页眉和页脚
    \fancyhead[C]{\song \fontsize{10.5pt}\selectfont 浙江财经大学本科毕业论文（设计）}
    \fancyfoot[C]{\thepage}
